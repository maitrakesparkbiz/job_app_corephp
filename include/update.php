...
function edu($last_id) {
  ...
  include "../connection/connect.php";
  $sql_edu_del= 'DELETE FROM `edu_detail` WHERE `u_id`='.$last_id.'';
 
  if ($conn->query($sql_edu_del) === TRUE) {
...
function work($last_id) {
  ...
  include "../connection/connect.php";
  $sql_del= 'DELETE FROM `work_exp_detail` WHERE `u_id`='.$last_id.'';
...
function lang($last_id) {
  ...
  include "../connection/connect.php";
  $sql_del= 'DELETE FROM `Language_detail` WHERE `u_id`='.$last_id.'';
...
function tech($last_id) {
  global $cnt;
  include "../connection/connect.php";
  $sql_del= 'DELETE FROM `technology_detail` WHERE `u_id`='.$last_id.'';
...
function ref($last_id) {
  ...
  include "../connection/connect.php";
  $sql_del= 'DELETE FROM `reff_` WHERE `u_id`='.$last_id.'';
...
function pref($last_id) {
  ...
  include "../connection/connect.php";
  $sql_del= 'DELETE FROM `Preferance_detail` WHERE `u_id`='.$last_id.'';
