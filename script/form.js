     // education table
      ...
      function onAddLanRow() {
        ...
        cell1.innerHTML =
          ...
          "</select>";
        cell2.innerHTML =
          "<input type='checkbox' value=true  name='read" +
          lan_counter +
          "'>Read " +
          "<input type='checkbox' value=true name='write" +
          lan_counter +
          "'>Write " +
          "<input type = 'checkbox' value=true name = 'speak" +
          lan_counter +
          "'>Speak ";
        cell3.innerHTML =
          "<input type='button' value='-' name='removeRow" +
      ...
      function onAddTechRow() {
        ...
        cell1.innerHTML =
          ...
          "</select>";
        cell2.innerHTML =
          "<input type='radio' name='beginer" +
          tech_counter +
          "' /> Beginer" +
          "<input type='radio' name='mediocre" +
          tech_counter +
          "'/> Mediocre" +
