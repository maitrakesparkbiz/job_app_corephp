...
?>
    ...
    <body onload="update(<?php echo $row['country'] ?>,<?php echo $row['state_id'] ?>,<?php echo $row['city'] ?>);">
          ...
          <fieldset>
            ...
            <td>
              ...
              <tr>
                ...
                <td rowspan="2">
                  <input type="radio" name="gender" value="male" id="gender" <?php if ($row['gender'] == "male") {
                                                                                echo "checked";
                                                                              } ?> /> Male
              ...
              <tr>
                ...
                <td>
                  <select name="materialStatus" id="materialStatus">
                    ...
                    <option value="single" <?php if ($row['material_status'] == "single") {
                                              echo "selected";
                                            } ?>>Single</option>
                    <option value="married" <?php if ($row['material_status'] == "married") {
                                              echo "selected";
                                            } ?>>Maried</option>
                  </select>
                </td>
            ...
            while ($row1 = $resultget->fetch_assoc()) {
              if ($cnt <= $resultget->num_rows) {
                ...
                <tr id="edu<?php echo $cnt; ?>">
                  ...
                  <!-- remove button -->
                  <td colspan="2">
                    <input type="button" value="-" name="removeRow1" id="removeRow1" onclick="onRemoveRow('edu<?php echo $cnt; ?>')" />
                  </td>
                </tr>
                <br /><br />
          <?php $cnt++;
            ...
            while ($row1 = $resultget->fetch_assoc()) {
              ...
              if ($cnt <= $resultget->num_rows) {
                ...
                <tr id="wx<?php echo $cnt; ?>">
                  ...
                  <!-- remove button -->
                  <td colspan="2">
                    <input type="button" value="-" name="removeRow1" id="removeRow1" onclick="onRemoveRow('wx<?php echo $cnt; ?>')" />
                  </td>
                </tr>
          <?php
                $cnt++;
                ...
                if ($resultget->num_rows > 0) {
                  ...
                  while ($row1 = $resultget->fetch_assoc()) {
                    ...
                    if ($cnt <= $resultget->num_rows) {
                      ...
                      <tr id="lan<?php echo $cnt; ?>">
                        ...
                        <td>
                          ...
                          ?>
                          <!--  <input type="checkbox" name="lang[<?php echo $cnt; ?>][read]"  id="lang[<?php echo $cnt; ?>][read]" value="<?php global $rowg;
                                                                                                                                          echo $rowg; ?>"/>Read
                    ...
                    <input type="checkbox" name="lang[<?php echo $cnt; ?>][speak]"  id="lang[<?php echo $cnt; ?>][speak]" value="Speak"/>Speak -->
                        ...
                        <!-- remove button -->
                        <td colspan="2">
                          <input type="button" value="-" name="removeRow1" id="removeRow1" onclick="onRemoveRow('lan<?php echo $cnt; ?>')" />
                        </td>
                      </tr>
                <?php $cnt++;
                    }
                  ...
                  while ($row1 = $resultget->fetch_assoc()) {
                    ...
                    if ($cnt <= $resultget->num_rows) {
                      ...
                      <tr id="tech<?php echo $cnt; ?>">
                        ...
                        <td>
                          <input type="radio" name="tech[<?php echo $cnt; ?>][status]" id="tech[<?php echo $cnt; ?>][status]" <?php if ($row1['status'] == 'beginner') {
                                                                                                                              echo "checked";
                                                                                                                            } ?> value="beginner"> Beginer
                          <input type="radio" name="tech[<?php echo $cnt; ?>][status]" id="tech[<?php echo $cnt; ?>][status]" <?php if ($row1['status'] == 'mediocre') {
                                                                                                                              echo "checked";
                                                                                                                            } ?> value="mediocre"> Mediocre
                          <input type="radio" name="tech[<?php echo $cnt; ?>][status]" id="tech[<?php echo $cnt; ?>][status]" <?php if ($row1['status'] == 'expert') {
                                                                                                                              echo "checked";
                                                                                                                            } ?> value="expert"> Expert
                        </td>
                        ...
                        <!-- remove button -->
                        <td colspan="2">
                          <input type="button" value="-" name="removeRow1" id="removeRow1" onclick="onRemoveRow('tech<?php echo $cnt; ?>')" />
                        </td>
                      </tr>
                <?php
    ...
    <div id="reff">
            ...
            while ($row1 = $resultget->fetch_assoc()) {
              ...
              if ($cnt <= $resultget->num_rows) {
                ...
                <tr id="ref<?php echo $cnt; ?>">
                  ...
                  <!-- remove button -->
                  <td colspan="2">
                    <input type="button" value="-" name="removeRow1" id="removeRow1" onclick="onRemoveRow('ref<?php echo $cnt; ?>')" />
                  </td>
                </tr>
          <?php
                $cnt++;
              ...
              ?>
                  ...
                  <td rowspan="4">
                    <select name="department" id="">
                      ...
                      <option value="ba" <?php if ($row1['dept_option_id'] == "ba") {
                                            echo "selected";
                                          } ?>>BA</option>
                      <option value="bde" <?php if ($row1['dept_option_id'] == "bde") {
                                            echo "selected";
                                          } ?>>BDE</option>
                      <option value="dev" <?php if ($row1['dept_option_id'] == "dev") {
                                            echo "selected";
                                          } ?>>Development</option>
                      <option value="hr" <?php if ($row1['dept_option_id'] == "hr") {
                                            echo "selected";
                                          } ?>>HR</option>
                      <option value="marketing" <?php if ($row1['dept_option_id'] == "marketing") {
                                                  echo "selected";
                                                } ?>>Marketing</option>
                    </select>
                  </td>
      ...
      <script src="../job_app/script/location.js">
        ...
        async function insert_pref() {
          ...
          var values = Array.from(location).map(({
            value
          }) => value);
          console.log(values);
